...
export default function DeleteModal({ onDelete, id, showDelete }) {
  const handleDelete = () => {
    onDelete(id);
    showDelete(false);
  };
  ...
  return (
    <>
      ...
      {/* <!-- Main modal --> */}
      <div id="deleteModal" tabindex="-1" aria-hidden="true" className="bg-gray-500 inset-0  hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
